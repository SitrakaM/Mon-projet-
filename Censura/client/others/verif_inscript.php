      ...
      <div class="wrapper">
        <div class="form-wrapper sign-up">
          <form action="#">
            ...
            $mail = $_POST["mail"];
            $mdp = $_POST["mdp"];
            $sql = "INSERT INTO artiste (Pseudo, Mail, Mdp,Profil) VALUES ('" . $user . "','" . $mail . "','" . $mdp . "','fd.jpg')";
            $sql1 = "SELECT * FROM artiste WHERE Pseudo ='" . $user . "' AND Mdp='" . $mdp . "'";
            ...
            if (isset($_POST["valider"])) {
              ...
              try {
                ...
                $_SESSION["cl_pseudo"] = $user;
                $_SESSION["cl_mail"] = $mail;
                $_SESSION["cl_profil"] = 'fd.jpg';
                $cpt = 0;
                ...
                echo "<div class='sign-link'><p><a href='accueil.php' class='signUp-link'>Valider</a></p></div>";
              } catch (Exception $e) {
