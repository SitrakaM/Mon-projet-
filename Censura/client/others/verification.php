...
<body>
    ...
    if (isset($_POST['valider'])) {
        ...
        $titre = $_POST['titre'];
        $lien = $_FILES['video']['name'];
        $genre = $_POST['genre'];
        $sql = "INSERT INTO publications(Titre, Lien, Genre, Statut, Id) VALUES ('" . $titre . "','" . $lien . "','" . $genre . "','0'," . $_SESSION['cl_id'] . ")";
        mysqli_query($db, $sql);
        upload_video('video');
    }
            ...
            <div class="containeR">
                ...
                <form action="#">
                    <div class="verification">
                        <h2>Votre video est maintenant envoyée aux administrateurs de Censura.</h2>
                        <p>Vous recevrez par E-Mail si votre video a pu être approuvée ou refusée</p>
