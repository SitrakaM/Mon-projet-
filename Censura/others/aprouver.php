...
<body>
    ...
    <div class="slidebar">
        ...
        <ul class="nav-list">
            ...
            <li>
                <a href="aprouver.php">
                    <i class="fa fa-check" style="color:rgb(6, 0, 43);font-size: 30px;"></i>
    ...
    <section class="home-section">
        ...
        <div id="Bbody">
            ...
            <div class="containeR">
                ...
                $sql = "SELECT * FROM approuver INNER JOIN publications WHERE publications.Id_Pub=approuver.id_video ORDER BY Id_app DESC";
